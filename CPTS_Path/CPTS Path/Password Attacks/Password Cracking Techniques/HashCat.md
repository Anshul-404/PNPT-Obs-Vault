- [Hashcat](https://hashcat.net/) is a **well-known password cracking tool for Linux, Windows, and macOS**. From 2009 until 2015 it was proprietary software, but has since been released as open-source.
