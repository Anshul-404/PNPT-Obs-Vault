...
- For example, u**sing the command below, or [this](https://web.archive.org/web/20230326230234/https://www.rapid7.com/db/modules/exploit/multi/http/jenkins_script_console/) Metasploit module.**:
...
- Running the above commands results in a reverse shell connection:
	- ![[Pasted image 20260720010816.png]]
